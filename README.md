...
2. Første gang en side indlæses, hentes `config.php`, `web.config`, `cacert-2025-08-12.pem` og `.gitignore` automatisk fra Tech Colleges delte konfigurationsmappe. Programmet prøver både `https://stha2.web.techcollege.dk/config/` og `http://stha2.web.techcollege.dk/config/` samt eventuelle alternative kilder, du opretter i `config/central_source.txt`.
