<article class="card card--top" data-tags="<?php echo htmlspecialchars(implode(' ', $story['tags'])); ?>">
    ...
    <footer class="card__footer">
        ...
        <?php endforeach; ?>
        <a class="read-more" href="<?php echo htmlspecialchars($story['url']); ?>" target="_blank" rel="noopener">Læs hos kilden →</a>
    </footer>
</article>
